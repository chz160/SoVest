    ...
    <div class="row">
        <div class="col-md-8 offset-md-2">
            <div class="prediction-form card shadow-sm">
                <div class="card-body">
                    <form id="prediction-form" action="{{ $isEditing ? route('predictions.update') : route('predictions.store') }}" method="post">
                        @csrf
                        ...
                        <div class="mb-3">
                            ...
                            @if ($isEditing)
                                <input type="text" class="form-control" id="stock-search" value="{{ $prediction['symbol'] . ' - ' . $prediction['company_name'] }}" readonly>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="reasoning" name="reasoning" rows="4" required>{{ $isEditing ? $prediction['reasoning'] : old('reasoning', '') }}</textarea>
