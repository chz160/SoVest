		...
		<div class="container py-3">
  			<header>
    			...
    			<div class="pricing-header p-3 pb-md-4 mx-auto text-center">
      				<p class="fs-5 text-body-secondary">WRK is designed to help track extracurricular work.</p>
    			</div>
 		 	</header>
					...
					<div class="col">
        				<div class="card mb-4 rounded-3 shadow-sm">
          					<div class="card-header py-3">
            					<h4 class="my-0 fw-normal">About WRK</h4>
          					</div>
          					<div class="card-body">
								<p>According to a research paper written by the Journal of College Teaching and Learning, increased extracurricular involvement can in some cases, have a negative impact on school performance. WRK is designed to help students track their extracurricular work, and visualize that data.</p>
							</div>
        				</div>
      				</div>
				</div>
